...
public class ImageAdapter extends ArrayAdapter<Image> {
    ...
    public ImageAdapter(Context context, ArrayList<Image> al_menu, int int_position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.iv_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //   Glide.with(context).load("file://"+ al_menu.get(int_position).getAl_imagepath().get(position)).into(ActivityCreatePhoto.instance.ivImage);
                Constances.imageSet = true;
                Intent i = new Intent(getContext(), CreatePhotoActivity.class);
                i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                i.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                //finishAffinity();
                i.putExtra("images", "" + al_menu.get(int_position).getAl_imagepath().get(position));
