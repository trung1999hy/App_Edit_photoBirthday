    ...
    private ImmutableList<QueryProductDetailsParams.Product> getInAppProductList() {
        ImmutableList<QueryProductDetailsParams.Product> productList = ImmutableList.of(
                ...
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_1_COIN)
                        .setProductType(INAPP)
                        .build(),

                //Product 2
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_2_COIN)
                        .setProductType(INAPP)
                        .build(),

                //Product 3
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_3_COIN)
                        .setProductType(INAPP)
                        .build(),

                //Product 4
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_4_COIN)
                        .setProductType(INAPP)
                        .build(),

                //Product 5
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_5_COIN)
                        .setProductType(INAPP)
                        .build(),

                //Product 6
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId(Containts.KEY_6_COIN)
                        .setProductType(INAPP)
                        .build()
        );
        return productList;
...
// lắng nghe trả về trạng thái mua
    ...
    private void setupResult(String proId, int quantity) {
        ...
        intent.putExtra(Containts.COIN_ORDER_RESULT, remainCoin + "");
    ...
    private int getCoinFromKey(String coin) {
        switch (coin) {
            case Containts.KEY_1_COIN:
                return 80;
            case Containts.KEY_2_COIN:
                return 130;
            case Containts.KEY_3_COIN:
                return 260;
            case Containts.KEY_4_COIN:
                return 520;
            case Containts.KEY_5_COIN:
                return 600;
            case Containts.KEY_6_COIN:
                return 700;
            case Containts.KEY_7_COIN:
                return 99;
            default:
                return 0;
        }
