...
import com.hst.simplephotoedior.adapter.AdapterFrameList;
...
public class ActivityHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointView.setOnClickListener(view -> {
            Intent intent = new Intent(ActivityHome.this, PurchaseInAppActivity.class);
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(ActivityHome.this, R.style.AlertDialogTheme);
